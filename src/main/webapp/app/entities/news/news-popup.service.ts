        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.newsService.find(id).subscribe((news) => {
                    news.createTime = this.datePipe
                        .transform(news.createTime, 'yyyy-MM-ddTHH:mm:ss');
                    news.updateTime = this.datePipe
                        .transform(news.updateTime, 'yyyy-MM-ddTHH:mm:ss');
                    news.expDate = this.datePipe
                        .transform(news.expDate, 'yyyy-MM-ddTHH:mm:ss');
